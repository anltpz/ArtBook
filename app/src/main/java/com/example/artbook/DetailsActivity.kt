...
class DetailsActivity : AppCompatActivity() {
    ...
    private lateinit var activityResultLauncher: ActivityResultLauncher<Intent> // soyut sınıf
    //bir sonuc için activity başlat
    private lateinit var database:SQLiteDatabase


    private lateinit var permissionLauncher: ActivityResultLauncher<String>// izinler string olarak dönüyor
